...
k_time = [
    ...
    {"time":"09:35-09:55", "text":"主题演讲：企业如何实现数字化转型"},
    {"time":"09:55-10:10", "text":"主题演讲：工赋园区、数智未来-锐捷网络带你迈向智能制造"},
    {"time":"10:10-10:25", "text":"主题演讲：工业数字化转型安全实践"},
    {"time":"10:25-10:30", "text":"签约仪式"},
    {"time":"10:30-10:40", "text":"茶歇及观展"},
    {"time":"10:40-11:00", "text":"案例分享：河北北方铸业有限公司就信息化建设进行分享"},
